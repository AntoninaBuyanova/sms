          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-6 lg:gap-12 items-center">
            ...
            <div className="md:col-span-7 lg:col-span-6 md:pl-4 lg:pl-0 order-1 md:order-2">
              <h2 className="text-[2rem] md:text-[2.2rem] lg:text-[3.25rem] font-aeonik font-medium leading-[1.2] md:leading-[1.3] lg:leading-[3.75rem] mb-6 text-[#232323]">
                Obtén fuentes verificadas<br className="hidden sm:block" /> con citas
              </h2>
              ...
              <ul className="space-y-4 md:space-y-4 mb-6 md:mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-base md:text-base lg:text-lg text-[#232323]">Entregamos más de 20 artículos de calidad adaptados a tu tema</span>
                </li>
                <li className="flex items-start">
                  <Check className="min-w-[24px] w-6 h-6 text-[#232323] mr-3 mt-0.5" />
                  <span className="text-base md:text-base lg:text-lg text-[#232323]">Cada resultado incluye ideas principales, citas y enlaces</span>
                </li>
                <li className="flex items-start">
                  <Check className="min-w-[24px] w-6 h-6 text-[#232323] mr-3 mt-0.5" />
                  <span className="text-base md:text-base lg:text-lg text-[#232323]">Exporta citas instantáneamente en formatos APA, MLA, Chicago y más</span>
                </li>
              </ul>
