...
const MainHeading: React.FC = () => {
  return (
    <h2 className="text-[2rem] md:text-[2.2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 text-[#232323] max-w-none text-render-opt loaded">
      Forma más inteligente de buscar, citar y almacenar
    </h2>
  );
};
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <FeatureCard 
              title="Ver citas e ideas principales al instante" 
              description="Obtén un análisis claro de cada artículo — con resúmenes, ideas centrales y citas"
              isWider={true}
            ...
            <FeatureCard 
              ...
              description="Buscamos en más de 100 millones de fuentes revisadas por pares de bibliotecas de investigación"
            ...
            >
              <div>
                <OptimizedImage 
                  src="/google.png" 
                  alt="Motores de búsqueda académicos" 
            ...
            <FeatureCard 
              ...
              description="Importa tus PDFs para extraer citas y encontrar referencias de apoyo"
            ...
            <FeatureCard 
              ...
              description="Guarda, organiza y descarga tus fuentes en cualquier momento"
              isWider={true}
              extraReducedHeight={true}
              className="md:col-span-1 lg:col-span-3"
              delay={300}
