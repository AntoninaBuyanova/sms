        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="mb-12 text-left">
            ...
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 text-[#232323] max-w-none">
              Hecho para velocidad y relevancia
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <StatCard 
              ...
              value="10h+"
              description="Ahorradas cada semana al evitar búsquedas manuales"
            />
            <StatCard 
              icon={<img src="books.png" alt="Libros" className="w-[3.5rem] md:w-[4rem] lg:w-[4.875rem]" />}
              value="100M+"
              description="Papers analizados de JSTOR, Semantic Scholar, ArXiv y más"
            />
            <StatCard 
            ...
            <StatCard 
              ...
              value="99%"
              description="De los resultados son relevantes — sin papers fuera de tema"
            />
          </div>
        </div>
      </div>
