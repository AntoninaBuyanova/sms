        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mb-12 text-left">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] text-[#232323] max-w-none">
              Para estudiantes, investigadores, profesionales y todos
            </h2>
          </div>
          ...
          <div className="mt-8 lg:mt-12 mb-12 lg:mb-[7.5rem]">
            <div className="flex md:grid md:grid-cols-3 md:gap-6 lg:gap-12 overflow-x-auto snap-x snap-mandatory scrollbar-hide pl-[20px] md:pl-0 -mr-4 md:mr-0">
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students1.png"
                  quote="Siempre me atoraba reescribiendo el mismo párrafo una y otra vez. Esto por fin me mostró qué estaba mal. Mi estructura no servía — la arreglé y mi calificación subió."
                  name="Samantha R."
              ...
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students2.png"
                  quote="Lo usé la noche antes de la entrega. Encontró puntos débiles que no vi, especialmente en el flujo del argumento. Hice algunos cambios y obtuve la mejor calificación del semestre."
                  name="Daniel M."
              ...
              <div className="snap-start md:snap-none">
                <Testimonial
                  image="students3.png"
                  quote="La neta, solo quería saber si mi ensayo estaba 'suficientemente bueno'. Resultó que algunas partes necesitaban trabajo. Las correcciones fueron rápidas y me salvó de entregar algo a medias."
                  name="Michael S."
          ...
          <div className="text-center">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] text-[#232323] mb-3 lg:mb-4">
              Comienza a citar de manera más inteligente
            </h2>
            <p className="text-[#3C3C3C] mb-6 lg:mb-10 text-base lg:text-[1.25rem] leading-normal lg:leading-[1.75rem]">
              Encuentra las fuentes correctas, extrae lo importante y cítalas en segundos — todo en un solo lugar
            </p>
