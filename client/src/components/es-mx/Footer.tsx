...
import { LinkedInIcon, TwitterIcon, InstagramIcon, YoutubeIcon, FacebookIcon } from '@/components/icons/Logo';
import { useLocation } from 'wouter';

// Language options for the selector
const languageOptions = [
  { code: 'en', name: 'Inglés', flag: '/icons/us-flag.svg' },
  { code: 'es', name: 'Español', flag: '/icons/es-flag.svg' },
  { code: 'es-mx', name: 'Español (México)', flag: '/icons/mx-flag.svg', displayCode: 'ES' },
  { code: 'pt', name: 'Portugués', flag: '/icons/pt-flag.svg' },
  { code: 'pt-br', name: 'Portugués (Brasil)', flag: '/icons/br-flag.svg', displayCode: 'PT' },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="https://mystylus.ai/ai-paper-generator/" className="text-[#232323] hover:opacity-70 font-aeonik">Generador de Artículos Académicos</a></li>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="https://mystylus.ai/ai-essay-writer/" className="text-[#232323] hover:opacity-70 font-aeonik">Asistente de Escritura con IA</a></li>
