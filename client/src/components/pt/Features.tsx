            ...
            <div className="md:col-span-7 lg:col-span-6 md:pl-4 lg:pl-0 order-1 md:order-2">
              ...
              <ul className="space-y-4 md:space-y-4 mb-6 md:mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-base md:text-base lg:text-lg text-[#232323]">Entregamos mais de 20 artigos de qualidade adaptados ao seu tema</span>
                </li>
                <li className="flex items-start">
                  <Check className="min-w-[24px] w-6 h-6 text-[#232323] mr-3 mt-0.5" />
                  <span className="text-base md:text-base lg:text-lg text-[#232323]">Cada resultado inclui insights principais, citações e links</span>
                </li>
                <li className="flex items-start">
                  <Check className="min-w-[24px] w-6 h-6 text-[#232323] mr-3 mt-0.5" />
                  <span className="text-base md:text-base lg:text-lg text-[#232323]">Exporte citações instantaneamente nos formatos APA, MLA, Chicago e outros</span>
                </li>
              </ul>
