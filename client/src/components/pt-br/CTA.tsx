        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mb-12 text-left">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] text-[#232323] max-w-none">
              Para estudantes, pesquisadores, profissionais e todos os públicos
            </h2>
          </div>
          ...
          <div className="mt-8 lg:mt-12 mb-12 lg:mb-[7.5rem]">
            <div className="flex md:grid md:grid-cols-3 md:gap-6 lg:gap-12 overflow-x-auto snap-x snap-mandatory scrollbar-hide pl-[20px] md:pl-0 -mr-4 md:mr-0">
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students1.png"
                  quote="Eu sempre ficava preso reescrevendo o mesmo parágrafo várias vezes. Isso finalmente me mostrou o que estava errado. Minha estrutura estava fraca — consertei e minha nota aumentou!"
                  name="Samantha R."
              ...
              <div className="snap-start md:snap-none mr-4 md:mr-0">
                <Testimonial
                  image="students2.png"
                  quote="Usei na véspera do prazo. Identificou pontos fracos que não percebi, principalmente no fluxo do argumento. Fiz algumas alterações e tirei a melhor nota do semestre."
                  name="Daniel M."
              ...
              <div className="snap-start md:snap-none">
                <Testimonial
                  image="students3.png"
                  quote="Sinceramente, só queria saber se meu trabalho estava 'bom o suficiente'. Descobri que algumas partes precisavam de ajustes. As correções foram rápidas e me salvaram de entregar algo mal acabado."
                  name="Michael S."
          ...
          <div className="text-center">
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] text-[#232323] mb-3 lg:mb-4">
              Comece a citar de modo mais inteligente
            </h2>
            <p className="text-[#3C3C3C] mb-6 lg:mb-10 text-base lg:text-[1.25rem] leading-normal lg:leading-[1.75rem]">
              Encontre as fontes certas, extraia o que importa e cite-as em segundos — tudo em um único lugar
            </p>
