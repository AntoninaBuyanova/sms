        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="mb-12 text-left">
            ...
            <h2 className="text-[2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 text-[#232323] max-w-none">
              Feito para velocidade e relevância
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <StatCard 
              ...
              value="10h+"
              description="Poupadas semanalmente ao evitar pesquisas manuais"
            />
            <StatCard 
              icon={<img src="books.png" alt="Livros" className="w-[3.5rem] md:w-[4rem] lg:w-[4.875rem]" />}
              value="100M+"
              description="Artigos verificados do JSTOR, Semantic Scholar, ArXiv e outros"
            />
            <StatCard 
              icon={<img src="pensilline.png" alt="Lápis" className="w-[3.5rem] md:w-[4rem] lg:w-[4.875rem]" />}
              value="5x"
              description="Escrita mais rápida com fontes, citações e resumos prontos"
            />
            <StatCard 
              icon={<img src="chart.png" alt="Gráfico" className="w-[3.5rem] md:w-[4rem] lg:w-[4.875rem]" />}
              value="99%"
              description="Dos resultados são relevantes — sem artigos fora do contexto"
            />
          </div>
        </div>
      </div>
