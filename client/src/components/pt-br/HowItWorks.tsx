...
const MainHeading: React.FC = () => {
  return (
    <h2 className="text-[2rem] md:text-[2.2rem] lg:text-[3.25rem] font-medium leading-[1.2] lg:leading-[3.75rem] mb-6 text-[#232323] max-w-none text-render-opt loaded">
      Forma mais inteligente de pesquisar, citar e armazenar
    </h2>
  );
};
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <FeatureCard 
              title="Veja citações e insights principais instantaneamente" 
              description="Obtenha uma análise clara de cada artigo — com resumos, ideias centrais e citações"
              isWider={true}
            ...
            <FeatureCard 
              title="Pesquise nas principais bases acadêmicas" 
              description="Buscamos em mais de 100 milhões de fontes revisadas por pares das melhores bibliotecas"
            ...
            >
              <div>
                <OptimizedImage 
                  src="/google.png" 
                  alt="Motores de busca acadêmicos" 
            ...
            <FeatureCard 
              title="Faça upload dos seus próprios arquivos" 
              description="Importe seus PDFs para extrair citações e encontrar referências complementares"
            ...
            >
              <div>
                <OptimizedImage 
                  src="/referenceu.png" 
                  alt="Carregamento de referências" 
                  className="w-full" 
                  width={400} 
                  height={300}
                />
            ...
            <FeatureCard 
              title="Mantenha suas fontes organizadas" 
              description="Salve, organize e baixe suas fontes quando quiser"
              isWider={true}
              extraReducedHeight={true}
              className="md:col-span-1 lg:col-span-3"
              delay={300}
