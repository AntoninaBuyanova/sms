...
const LogoCloud = lazy(() => import('../components/pt/LogoCloud'));
const Features = lazy(() => import('../components/pt/Features'));
const Testimonials = lazy(() => import('../components/pt/Testimonials'));
const HowItWorks = lazy(() => import('../components/pt/HowItWorks'));
const CTA = lazy(() => import('../components/pt/CTA'));
const Footer = lazy(() => import('../components/pt/Footer'));

// Simple fallback for lazy components
const SectionFallback = () => <div className="w-full h-32 bg-slate-50"></div>;

const PortuguesePage: React.FC = () => {
  useEffect(() => {
    ...
    if ('requestIdleCallback' in window) {
      window.requestIdleCallback(() => {
        import('../components/pt/Features');
        import('../components/pt/HowItWorks');
      });
    }
